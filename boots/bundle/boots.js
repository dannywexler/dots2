...
var require_remove = __commonJS({
  "node_modules/.pnpm/fs-extra@10.1.0/node_modules/fs-extra/lib/remove/index.js"(exports, module2) {
    ...
    function remove(path2, callback) {
      if (fs4.rm)
        return fs4.rm(path2, { recursive: true, force: true }, callback);
      rimraf(path2, callback);
    }
    function removeSync(path2) {
      if (fs4.rmSync)
        return fs4.rmSync(path2, { recursive: true, force: true });
      rimraf.sync(path2);
    }
    module2.exports = {
      remove: u(remove),
...
__export(build_exports, {
  ...
  log: () => log,
  nothrow: () => nothrow,
  os: () => import_node_os2.default,
  path: () => import_node_path3.default,
  question: () => question,
  quiet: () => quiet,
  quote: () => quote,
...
var getNonSpecFormDataBoundary = (0, import_node_util3.deprecate)(
